  ...
  const fetchData = async () => {
    ...
    try {
      const results = await Promise.allSettled([
        ...
        apiGet(API_ENDPOINTS.ATTENDANCE),
        apiGet(API_ENDPOINTS.PAYMENT_PLAN_ALL_INSTALLMENTS),
        apiGet(API_ENDPOINTS.FINAL_GRADES),
        apiGet(API_ENDPOINTS.SUBJECTS),
      ]);

      const [studentsRes, enrollmentsRes, paymentsRes, plansRes, uniformRes, sectionsRes, yearLevelsRes, attendanceRes, allInstallmentsRes, finalGradesRes, subjectsRes] = results;
      ...
      setAttendance(normalize(attendanceRes));
